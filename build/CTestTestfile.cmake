...
set_tests_properties(async_fifo_near_full_tb PROPERTIES  DEPENDS "test_async_fifo_near_full_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_near_empty_tb "/usr/bin/vvp" "/workspace/build/async_fifo_near_empty_tb.vvp")
set_tests_properties(async_fifo_near_empty_tb PROPERTIES  DEPENDS "test_async_fifo_near_empty_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_depth_variation_tb "/usr/bin/vvp" "/workspace/build/async_fifo_depth_variation_tb.vvp")
set_tests_properties(async_fifo_depth_variation_tb PROPERTIES  DEPENDS "test_async_fifo_depth_variation_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_width_variation_tb "/usr/bin/vvp" "/workspace/build/async_fifo_width_variation_tb.vvp")
set_tests_properties(async_fifo_width_variation_tb PROPERTIES  DEPENDS "test_async_fifo_width_variation_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_random_traffic_tb "/usr/bin/vvp" "/workspace/build/async_fifo_random_traffic_tb.vvp")
set_tests_properties(async_fifo_random_traffic_tb PROPERTIES  DEPENDS "test_async_fifo_random_traffic_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_clock_jitter_tb "/usr/bin/vvp" "/workspace/build/async_fifo_clock_jitter_tb.vvp")
set_tests_properties(async_fifo_clock_jitter_tb PROPERTIES  DEPENDS "test_async_fifo_clock_jitter_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_clock_switching_tb "/usr/bin/vvp" "/workspace/build/async_fifo_clock_switching_tb.vvp")
set_tests_properties(async_fifo_clock_switching_tb PROPERTIES  DEPENDS "test_async_fifo_clock_switching_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_prog_full_accuracy_tb "/usr/bin/vvp" "/workspace/build/async_fifo_prog_full_accuracy_tb.vvp")
set_tests_properties(async_fifo_prog_full_accuracy_tb PROPERTIES  DEPENDS "test_async_fifo_prog_full_accuracy_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_flag_consistency_tb "/usr/bin/vvp" "/workspace/build/async_fifo_flag_consistency_tb.vvp")
set_tests_properties(async_fifo_flag_consistency_tb PROPERTIES  DEPENDS "test_async_fifo_flag_consistency_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_asymm_boundary_tb "/usr/bin/vvp" "/workspace/build/async_fifo_asymm_boundary_tb.vvp")
set_tests_properties(async_fifo_asymm_boundary_tb PROPERTIES  DEPENDS "test_async_fifo_asymm_boundary_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
add_test(async_fifo_asymm_ratios_tb "/usr/bin/vvp" "/workspace/build/async_fifo_asymm_ratios_tb.vvp")
set_tests_properties(async_fifo_asymm_ratios_tb PROPERTIES  DEPENDS "test_async_fifo_asymm_ratios_tb_compile" WORKING_DIRECTORY "/workspace/build" _BACKTRACE_TRIPLES "/workspace/CMakeLists.txt;146;add_test;/workspace/CMakeLists.txt;0;")
